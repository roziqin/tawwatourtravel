		...
		if( $sidebar_type == 'right' || $sidebar_type == 'both' ){
			...
			?>
				...
				<div class=" traveltour-sidebar-right traveltour-column-20 traveltour-line-height traveltour-line-height">
					<div class="traveltour-sidebar-area traveltour-item-pdlr ct-blog related">
						<div>	
							<h5>BLOG LAINNYA</h5>
							<?php
								...
								<div class="custom-box">
									   <article class="ct-article ct-fw-600 ct-article--inline">
									      <div class="ct-article-media">
									         <a href="<?php echo $url_tour; ?>" itemprop="url">
									            <div class="blog-image" style="background-image:url('<?php echo $thumb_url[0]; ?>');"></div>
									         </a>
									      </div>
									      <div class="ct-article-body">
									         <div class="ct-article-title">
									            <a href="<?php echo $url_tour; ?>" itemprop="url">
									               <h5 class="text-uppercase ct-u-colorMotive ct-fw-700"><?php echo $title; ?></h5>
									            </a>
									         </div>
									         <div itemprop="text" class="ct-article-description"><a href="<?php echo $url_tour; ?>" itemprop="url" class="btn-read-more">Baca Selengkanya &gt;</a></div>
									      </div>
									   </article>
									</div>
								<?php
